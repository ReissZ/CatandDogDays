...
//  CatDogYears
//
//  Created by Reiss Zurbyk on 2015-12-05.
...
class MainVC: UIViewController, AVAudioPlayerDelegate {
    ...
    @IBAction func calculateCatYearsTapped(_ sender: AnyObject) {
    ...
    @IBAction func calculateDogYearsTapped(_ sender: AnyObject) {
        ...
        do {
            try playSound("dogbark", fileExtension: "wav")
        } catch {
            return
        }
        
        dogAgeResult.isHidden = false
        dogAgeEntry.text = ""
    ...
    @IBAction func getRandomFactoid(_ sender: AnyObject) {
